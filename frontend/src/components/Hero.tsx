  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
        {/* Avatar */}
        <div
          className={`mh-5 mb-2 mt-13 w-50 h-50 sm:w-65 sm:h-65 rounded-full bg-gradient-to-br from-blue-600 via-purple-600 to-blue-900 p-1 flex items-center justify-center transition-opacity duration-500 ${
